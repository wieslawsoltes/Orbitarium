...
Dependency-free DOM controls and virtualization. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

$, $$, el, number, ICONS, icon, hydrateIcons, toast, openDialog, bindTabs, VirtualList, CommandPalette.
...
```js
import * as orbitarium from '@orbitarium/ui';
```
