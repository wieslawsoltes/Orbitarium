# @orbitarium/simulation

Coordinated physics, actual-time accounting and snapshots. Original ES-module implementation, MIT licensed, version 0.1.0.
...
```js
import * as orbitarium from '@orbitarium/simulation';
```
