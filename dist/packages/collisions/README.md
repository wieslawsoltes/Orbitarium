# @orbitarium/collisions

Swept sphere interactions and explicit sandbox fragmentation. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

sweptHit, mergeBodies, fragmentBody, CollisionEngine.
...
```js
import * as orbitarium from '@orbitarium/collisions';
```
