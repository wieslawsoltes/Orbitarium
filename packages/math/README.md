...
Unit constants and orbital/vector mathematics. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

AU_KM, DAY_S, SOLAR_KG, EARTH_MASS, G, TAU, clamp, lerp, dot, cross, length, add, sub, scale, normalize, distance, kmPerSecond, auPerDay, seededRandom, colorRGB, finiteNumber, orbitalElements, keplerState.
...
```js
import * as orbitarium from '@orbitarium/math';
```
