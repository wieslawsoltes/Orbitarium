...
Direct and Barnes–Hut forces, leapfrog integration and diagnostics. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

directAcceleration, BarnesHutTree, CPUSolver, invariants, stableStep.
...
```js
import * as orbitarium from '@orbitarium/gravity';
```
