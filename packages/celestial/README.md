# @orbitarium/celestial

Rounded body templates and dynamically integrated scenario factories. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

CATALOG, getTemplate, addOrbit, centerBarycenter, addBelt, SCENARIOS, createScenario.
...
```js
import * as orbitarium from '@orbitarium/celestial';
```
