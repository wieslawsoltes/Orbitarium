...
WebGPU/Canvas celestial rendering and orthographic camera. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

UniverseRenderer, OrbitCamera.
...
```js
import * as orbitarium from '@orbitarium/renderer';
```
