...
Validated Float64 structure-of-arrays body storage and history. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

MAX_BODIES, KINDS, validateBody, BodyStore, Signal, CommandHistory.
...
```js
import * as orbitarium from '@orbitarium/core';
```
