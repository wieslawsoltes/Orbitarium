...
Standalone WGSL assets and their loading interface. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

kernelURL, loadKernel; gravity.wgsl, bodies.wgsl, background.wgsl.
...
```js
import * as orbitarium from '@orbitarium/kernels';
```
