...
Lumped temperature and material-radius models. Original ES-module implementation, MIT licensed, version 0.1.0.

## Exports

MATERIAL_DENSITY, equilibriumTemperature, materialRadius, surfaceState, stellarLuminosity, ThermalEngine.
...
```js
import * as orbitarium from '@orbitarium/thermal';
```
